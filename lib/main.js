...
//Fortunes
var messageWrapper = document.getElementById('fortune');

var messageItems = ['You look like you need a treat!', 'Take a walk.', 'Try again later.', 'Stay Pawsitive!', 'Youre a good dog.', 'Your lucky numbers are 6, 42, 8, 27, 24, 56', 'You look like Charlie needs a treat', 'Laugh often, and with a dog.', 'Give treats to others.', 'Cherish your loved ones.'];

var messageSection = document.querySelector('section.hide');

var getRandomMessage = function getRandomMessage() {
  messageItems.sort(function () {
...
for (var _i4 = 0; _i4 < thirdBoxes.length; _i4++) {
  thirdBoxes[_i4].addEventListener('click', displayMessage);
};